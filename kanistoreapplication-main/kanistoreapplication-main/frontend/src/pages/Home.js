...
const Home = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="font-bold text-2xl mb-4">Indhu Stores</div>
        <p className="text-lg font-semibold">Contact Us: 99948632--</p>
        <div className="text-sm mt-8 pt-4">
          &copy;2025 Indhu Stores. All rights reserved. Premium Quality Products.
        </div>
      </div>
    </div>
  );
